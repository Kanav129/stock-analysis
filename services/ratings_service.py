...
class RatingsService:
    def get_latest_ratings(self) -> list[dict[str, Any]]:
        """Latest rating per ticker, preferring research-report ratings over analysis ratings."""
        analysis = {r["ticker"]: r for r in self._latest_analysis_ratings()}
        reports = {r["ticker"]: r for r in self._latest_report_ratings()}

        tickers = sorted(set(analysis) | set(reports))
    ...
    def _latest_analysis_ratings(self) -> list[dict[str, Any]]:
        db = get_db_client()
    ...
    def _latest_report_ratings(self) -> list[dict[str, Any]]:
